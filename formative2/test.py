    ...
    if choice == "1":
        ...
        if stock_input == "1":
            ...
            if stock_prompt == "3":
                if stock_prompt_2 == "1":
                    stock_shop1["Computer"] = stock_shop1["Computer"] + int(stock_prompt_3)
                    print("Stock for shop 3 has been updated to: " + str(stock_shop1) + " At R2500  per Computer, R100 per RaspPi, and R800 per Monitor")
            ...
            if stock_prompt == "4":
                if stock_prompt_2 == "1":
                    stock_shop1["Computer"] = stock_shop1["Computer"] + int(stock_prompt_3)
                    print("Stock for shop 4 has been updated to: " + str(stock_shop1) + " At R2500  per Computer, R100 per RaspPi, and R800 per Monitor")
